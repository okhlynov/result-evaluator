...
class Engine:
    ...
    def run_inference(self, run_config: RunConfig, input_data: dict) -> dict:
    ...
    def eval_assert(self, rule: AssertRule, document: dict) -> tuple[bool, str]:
        """
    ...
    def run_test(self, test_case: Scenario) -> dict:
